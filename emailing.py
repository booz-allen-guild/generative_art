...
FALLBACK_EMAIL_SENDER = user
FALLBACK_EMAIL_PASSWORD = password
...
<p>
Thanks for stopping by the Booz Allen office at the CIC!
<p>
...
def _save_image(email_address, capture, cache_dir):
    ...
    image = postprocessing.postprocess(image, length=IMAGE_RESIZE_WIDTH)
